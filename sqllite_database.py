...
def create_database():
    ...
    """
    conn = lite.connect('dublinbikes_database.db',  isolation_level = None) # connect () works by searching for a database file and connecting to it
...
def database_backup(database, backup):
    ...
    """
    #Backup to sql file
    conn = lite.connect('dublinbikes_database.db',  isolation_level = None)
